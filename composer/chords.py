...
class MajorChord(Chord):
    @property
    def intervals(self):
        return [self.temperament.UNISON, self.temperament.MAJOR_THIRD, self.temperament.PERFECT_FIFTH]


class MinorChord(Chord):
    @property
    def intervals(self):
        return [self.temperament.UNISON, self.temperament.MINOR_THIRD, self.temperament.PERFECT_FIFTH]


class Sus2Chord(Chord):
    @property
    def intervals(self):
        return [self.temperament.UNISON, self.temperament.MAJOR_SECOND, self.temperament.PERFECT_FIFTH]


class Sus4Chord(Chord):
    @property
    def intervals(self):
        return [self.temperament.UNISON, self.temperament.PERFECT_FOURTH, self.temperament.PERFECT_FIFTH]


class DiminishedChord(Chord):
    @property
    def intervals(self):
        return [self.temperament.UNISON, self.temperament.MINOR_THIRD, self.temperament.DIMINISHED_FIFTH]


class AugmentedChord(Chord):
    @property
    def intervals(self):
        return [self.temperament.UNISON, self.temperament.MAJOR_THIRD, self.temperament.MINOR_SIXTH]
...
class ChordFactory:
    ...
    @classmethod
    def get_chord_builder(cls, quality: str, temperament: Temperament = EqualTemperament):
    ...
    @classmethod
    def get_chord(cls, root_frequency: int, quality: str, temperament: Temperament = EqualTemperament):
        ...
        def get_interval_from_extension_quality(q: str):
            try:
                return temperament.named_interval(q)
